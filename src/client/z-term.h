...
extern bool (*z_ask_confirm_aux)(const char *prompt);
extern bool (*z_ask_command_aux)(const char *prompt, bool shopping);
extern bool (*z_ask_dir_aux)(const char *prompt, bool allow_target, bool allow_friend);
...
extern errr Term_show_keyboard(int hint);
extern errr Term_hide_keyboard(void);
extern errr Term_window_updated(u32b flags);
