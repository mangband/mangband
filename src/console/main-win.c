...
/* undefine those for the console */
#undef USE_GRAPHICS
#undef USE_SOUND
...
static void load_prefs(void)
{
    ...
    GetPrivateProfileString("MAngband", "pass", "undefined", pass, 19, ini_file);
    GetPrivateProfileString("MAngband", "host", "undefined", server_name, 79, ini_file);
