...
extern int send_floor(player_type *p_ptr, byte attr, int amt, byte tval, byte flag, byte s_tester, cptr name);
extern int send_inven(player_type *p_ptr, char pos, byte attr, int wgt, int amt, byte tval, byte flag, byte s_tester, cptr name);
...
extern int send_store(player_type *p_ptr, char pos, byte attr, s16b wgt, s16b number, long price, cptr name);
...
extern bool enchant_spell(player_type *p_ptr, int num_hit, int num_dam, int num_ac);
extern bool enchant_spell_aux(player_type *p_ptr, int item, int num_hit, int num_dam, int num_ac);
...
extern void brand_ammo(player_type *p_ptr, int item);
extern void brand_weapon(player_type *p_ptr);
extern bool brand_bolts(player_type *p_ptr);
